...
/*   Updated: 2023/08/20 21:37:06 by cbolat           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_move_player(t_data *data)
{
	...
	if (data->map.map
		[(int)data->player.pos.y][(int)data->player.pos.x] == COLLECS)
	{
		data->map.map
		[(int)data->player.pos.y][(int)data->player.pos.x] = EMPTY_SPACE;
		ft_ll_remove(&data->map.ll_collect, data->player.pos.x,
			data->player.pos.y);
	}
}
